...
ggsave(plot = z, filename = here('ms_figs/figS1_n_sensitivity.png'), 
       width = 6.5, height = 4.3, units = 'in', dpi = 300)

knitr::include_graphics(here('ms_figs/figS1_n_sensitivity.png'))
```
