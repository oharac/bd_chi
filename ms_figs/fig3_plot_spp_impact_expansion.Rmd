...
font_add(family = 'bentonmed', 
         regular = file.path('/Library/Fonts', 
                             'BentonSans Condensed Medium', 
                             'BentonSans Condensed Medium.otf'))
...
fig3a_box <- ggplot(boxplot_df, aes(y = pct_impact, x = desc)) +
  ...
  theme(text = element_text(family = 'benton'),
        ...
        axis.title.x = element_text(family = 'bentonbold'),
...
fig3b <- ggplot(plot_tax_sum_df) +
  ...
  theme(text = element_text(family = 'benton'),
        ...
        legend.background = element_blank(),
        legend.title = element_text(size = 7, family = 'bentonbold', color = 'grey20'),
...
fig3 <- plot_grid(fig3a_box + theme(legend.position = 'none'), 
  ...
  draw_plot(legend_3b, x = .73, y = .18, width = .2, height = .4) +
  draw_label('A', x = .005, y = .99, vjust = 1, hjust = 0, 
             fontfamily = 'bentonbold', size = 10, colour = 'grey20') +
  draw_label('B', x = .545, y = .99, vjust = 1, hjust = 0, 
             fontfamily = 'bentonbold', size = 10, colour = 'grey20')
