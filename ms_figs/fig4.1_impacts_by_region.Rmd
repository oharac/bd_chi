...
georgn_lbls_df <- eez_plot_df %>%
  ...
  mutate(r1_label = str_replace(r1_label, ' and ', '\nand '))
...
fig4_done <- ggdraw() +
  draw_plot(get_panel(fig4_eez_labels),
            x = 0, y = 0.016, width = l_w, height = .96) + 
  ...
  draw_plot(get_panel(fig4_rgn_labels),
            x = .90, y = 0.01, width = .085, height = .96) +
...
ggsave(plot = fig4_done, filename = here('ms_figs/fig4.1_impact_by_eez.png'), 
       width = 12, height = 12, units = 'cm', dpi = 300)

knitr::include_graphics(here('ms_figs/fig4.1_impact_by_eez.png'))
```
