...
fig4_eez_labels <- ggplot(eez_plot_df %>% filter(stressor == 'cumulative'),
                          aes(x = pos)) +
  ggtheme_plot(base_size = 8) +
  geom_text(aes(label = lbl), y = 0, color = 'grey20', family = 'benton',
...
fig4_rgn_labels <- ggplot(georgn_lbls_df,
  ...
  geom_text(aes(label = georgn), x = -.05, color = 'grey20', family = 'benton',
...
fig4_done <- ggdraw() +
  ...
  draw_label(x = l_w, y = .98,         label = 'Cumulative', 
             color = 'grey20', size = 7, hjust = 0, vjust = 0, fontfamily = 'bentonbold') +
  ...
  draw_label(x = l_w + 4*c_w, y = .98, label = 'Land-based', 
             color = 'grey20', size = 7, hjust = 0, vjust = 0, fontfamily = 'bentonbold') +
  draw_label(x = 0.50, y = 0.005, 
             label = 'Mean proportion of species range impacted within EEZ', 
             color = 'grey20', size = 7, hjust = .5, vjust = 0, fontfamily = 'bentonbold')
