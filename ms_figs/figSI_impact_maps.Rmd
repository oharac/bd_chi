...
ggsave(plot = nspp_map, filename = here('ms_figs/si_spp_richness.png'),
       height = 5, width = 12, units = 'cm', dpi = 300)

knitr::include_graphics(here('ms_figs/si_spp_richness.png'))
```
...
figfile <- here('ms_figs/si_impact_pct_four_stressors.png')
...
if(!file.exists(figfile)) {
  ...
  fig_si <- ggdraw() +
    ...
    draw_label('Fishing impacts',
               ...
               size = 5, color = 'grey20', fontface = 'bold') +
...
figfile <- here('ms_figs/si_impact_pct_by_taxon.png')
# unlink(figfile)
