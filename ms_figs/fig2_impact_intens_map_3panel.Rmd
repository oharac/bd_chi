...
if(any(!file.exists(fig2_file, fig2_tiff)) | reload) {
  # unlink(fig2_file)
  ...
  fig2 <- ggdraw() +
    ...
    draw_label('A', x = .005, y = .97, vjust = 1, hjust = 0, 
               size = 10, color = 'grey20',
               fontfamily = 'bentonbold') +
    draw_label('B', x = .005, y = .65, vjust = 1, hjust = 0, 
               size = 10, color = 'grey20',
               fontfamily = 'bentonbold') +
    draw_label('C', x = .005, y = .32, vjust = 1, hjust = 0, 
               size = 10, color = 'grey20',
               fontfamily = 'bentonbold') +
    draw_label('Species affected\n(count)', x = .93, y = .97, hjust = 1, vjust = 1, 
               size = 8, color = 'grey20', fontfamily = 'bentonbold') +
