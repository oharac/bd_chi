...
writeRaster(rast_cuts, file.path(dir_cons, 'chi_thresholds.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'chi_trend_thresholds.tif'), 
            overwrite = TRUE)
...
writeRaster(rast_cuts, file.path(dir_cons, 'nspp_thresholds.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'sr_rr_thresholds.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'risk_thresholds.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'risk_rr_thresholds.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'threat_thresholds.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'threat_rr_thresholds.tif'), 
            overwrite = TRUE)
```
