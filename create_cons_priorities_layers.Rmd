...
writeRaster(rast_cuts, file.path(dir_cons, 'chi_thresholds_10km.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'chi_trend_thresholds_10km.tif'), 
            overwrite = TRUE)
...
writeRaster(rast_cuts, file.path(dir_cons, 'nspp_thresholds_10km.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'sr_rr_thresholds_10km.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'risk_thresholds_10km.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'risk_rr_thresholds_10km.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'threat_thresholds_10km.tif'), 
            overwrite = TRUE)
```
...
writeRaster(rast_cuts, file.path(dir_cons, 'threat_rr_thresholds_10km.tif'), 
            overwrite = TRUE)
```
