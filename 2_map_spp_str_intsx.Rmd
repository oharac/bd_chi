...
intsx_df <- spp_str_df %>%
  ...
  inner_join(spp_comp, by = 'iucn_sid')

spp_ids <- intsx_df$iucn_sid %>% unique() %>% sort()

str_names <- intsx_df$stressor %>% unique() %>% sort()
